...
// import './Home.css';
// import { IonContent, IonGrid, IonRow, IonCol, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonAlert } from '@ionic/react';
...
//     { id: 4, name: 'Tessssubah', phone: '52222222222', image: 'assets/alice_johnson.jpg' },
...
//               <IonCard onClick={() => handleCardClick(item.phone)} className="custom-card">
